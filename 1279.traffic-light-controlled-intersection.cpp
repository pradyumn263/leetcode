 ...
 * direction 2. Second road is road B where cars travel from West to East in
 * direction 3 and from East to West in direction 4.
 * 
 * 
 * 
 ...
 * for road B.
 * "Car 2 Has Passed Road B In Direction 4",    // Car 2 crosses as the light
 * is green on road B now.
 ...
 * "Car 2 Has Passed Road B In Direction 4",    // Car 2 crosses as the light
 * is green on road B now.
 * "Car 3 Has Passed Road B In Direction 3",    // Car 3 crosses as the light
 * is green on road B now.
 * "Traffic Light On Road A Is Green",          // Car 5 requests green light
 * for road A.
 * "Car 5 Has Passed Road A In Direction 1",    // Car 5 crosses as the light
 * is green on road A now.
 * "Traffic Light On Road B Is Green",          // Car 4 requests green light
 * for road B. Car 4 blocked until car 5 crosses and then traffic light is
 * green on road B.
 * "Car 4 Has Passed Road B In Direction 3"     // Car 4 crosses as the light
 * is green on road B now.
 * ]
 * Explanation: This is a dead-lock free scenario. Note that the scenario when
 * car 4 crosses before turning light into green on road A and allowing car 5
 * to pass is also correct and Accepted scenario.
 * 
 * 
 * 
 * Constraints:
